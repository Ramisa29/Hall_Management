...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  List<String> roomOptionsA = ['101', '102', '103','104','105','106','107','108'];
  List<String> roomOptionsB = ['110', '111', '112','113','114'];
  List<String> roomOptionsC = ['115', '116', '117','118','119','120','121'];
  List<String> roomOptionsD = ['122', '123', '124','125'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: Color.fromARGB(255, 80, 157, 246),
                    ...
                    Expanded(
                      child: Container(
                        ...
                        decoration: ShapeDecoration(
                          shape: RoundedRectangleBorder(
                            side: const BorderSide(
                                width: 1, color: Color.fromARGB(255, 99, 185, 239)),
                            borderRadius: BorderRadius.circular(14),
                          ),
                        ),
                        child: Row(
